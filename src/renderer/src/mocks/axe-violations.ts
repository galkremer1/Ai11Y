    ...
    nodes: [
      {
        ...
        target: ['.subtitle'],
        failureSummary: 'Fix any of the following: Element has insufficient color contrast of 2.85 (foreground color: #999999, background color: #ffffff, font size: 12pt, font weight: normal). Expected contrast ratio of 4.5:1'
      }
    ]
  },
  {
